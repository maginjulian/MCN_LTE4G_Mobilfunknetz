...
%\title{Reif für die Insel? Willkommen in der Lagune für Technologie und Entertainment}

%\title{Wer liefert welche Komponenten für ein Mobilfunknetz?}
\title{Reif für die Insel? Willkommen im LTE - Paradies!}% R15.}%- dem High Tech Ressort}
%
...
\thanks{Felix~Voglsam, Julian~Timo~Magin, and~Wolfgang~Eisenhut were with the FH Campus Wien (FHCW)\abk{FHCW}{Fachhochschule Campus Wien} Favoritenstraße 226 1100 Wien, Austria e-mail: felix.voglsam@stud.fh-campuswien.ac.at,\ julian.timo.magin@stud.fh-campuswien.ac.at,\ wolfgang.eisenhut@stud.fh-campuswien.ac.at.}% <-this % stops a space
